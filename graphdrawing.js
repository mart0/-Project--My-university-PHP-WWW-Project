					...
					complete: function(info){
						...
						if(dates!=null){
							for(var i=0;i<dates.length;i++){
								if(dates[i]!=0 && temps[i]!=0 && humidities[i]!=0 && image[i]!=0){
									...
									case 2:
									  ...
									  break;
									  case 3:
									  $('#field_3day').find('#day_date_'+i).find('.image').attr("src","images/rainy.png");
									  break;
									}
									$('#field_3day').find('.date_'+i).text(dates[i]);
									$('#field_3day').find('.temperature_'+i).text(temps[i]);
							...
							for(var i=0;i<3;i++){
								...
								$('#field_3day').find('.humidity_'+i).text("no info");
							}
						}
