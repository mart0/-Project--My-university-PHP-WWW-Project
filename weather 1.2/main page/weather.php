...
<body>
	...
	<div id="wrapper">
		...
		<nav class="left clear">
			<ul>
				<li><a href="#">Main</a></li>
				<li><a href="#">Forecast today</a></li>
				<li><a href="#">Forecast tommorow</a></li>
				<li class="right clear"><a href="#">Log in</a></li>
				<li class="right clear"><a href="admin_form.php">Admin panel</a></li>
			</ul>
		</nav>
			...
			<section class="left clear">
				...
				<div id="sofia_24_field">
					...
					<div class="hidden_fields1">
						<p>+12</p><button class="back">"<<"</button>
						<form action="">
							<label for="hour_new">Date: </label>
							<input type="date" min="1" max="2014" class="hour_new" required="required"><br/><br/><br/>
							<label for="temperature_new" >Temperature: </label>
					...
					<div class="hidden_fields1">
						<p>+20</p><button type="button">">>"</button>
						<form action="">
							<label for="hour_new">Date: </label>
							<input type="date" min="1" max="2014" class="hour_new" required="required"><br/><br/><br/>
							<label for="temperature_new" >Temperature: </label>
				...
				<div id="plovdiv_today_pic">
				</div>
				<div id="plovdiv_24_pic"></div>
				<div id="plovdiv_5day_pic"></div>
				</div>
				...
				<div id="stara_zagora_today_pic"></div>
				<div id="stara_zagora_24_pic"></div>
				<div id="stara_zagora_5day_pic"></div>
				</div>
			</section>
		</div>
		<footer>
