			...
			$('#today').on('click',function(){
				...
				$.ajax({
					...
					complete: function(info){
						console.log(info.responseJSON.date);
						...
						// $('#sofia_5day_field').show("fast");
						// console.log(dates[2]);
						// for(var i=0;i<dates.length;i++){
						// 	$('#sofia_5day_field').find('.date_'+i).text(dates[i]);
						// 	$('#sofia_5day_field').find('.temperature_'+i).text(temps[i]);
						//  	$('#sofia_5day_field').find('.humidity_'+i).text(humidities[i]);
						// }
					}	
				});
			});
